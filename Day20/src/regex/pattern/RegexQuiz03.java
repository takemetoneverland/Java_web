...
public class RegexQuiz03 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			br = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\D\\Desktop\\Java_Web_JDE\\건담.txt"), "UTF-8"));

			String line;
			while((line = br.readLine()) != null) {

				// 정규표현식
				String pattern1 = "\\d{8}-\\d{2}-\\d{12,13}"; //날짜 패틴
	...
	public static void excel(List<Product> list) {
		...
		try {
			fos = new FileOutputStream("C:\\Users\\D\\Desktop\\Java_Web_JDE\\건담.xlsx");
			wb.write(fos);
