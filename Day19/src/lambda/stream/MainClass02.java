...
public class MainClass02 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 - Function - 매개변수를 받고, (새로운)임의의 값을 반환
		 - Consumer - 매개변수를 받고, 반환은 없는 형태
		 - Supplier - 매개변수는 없고, 반환 형태는 지정 가능 (Consumer의 반대)
		 */
		...
		Stream<Integer> s1 = list.stream()
								 .filter((num) -> num % 2 == 0);
								 //작성한 조건식의 결과가 true면 리턴. false면 리턴하지 않음.
		...
		list.stream()
			.map((t) -> t > 50 ? t : 0) //map이라는 메서드의 return값이 stream에 반환되어서
										//메서드 체인링이 가능하다.
