...
public class BufferedQuiz02 {
	...
	public static void main(String[] args) {
		...
		File file = new File("C:\\Users\\D\\Desktop\\Java_Web_JDE\\file\\" + today + "file");
		...
		try {
			bw =
				new BufferedWriter(new FileWriter("C:\\Users\\D\\Desktop\\Java_Web_JDE\\file\\" + today + "file\\" + str + ".txt"));
		
			System.out.println("'그만'을 입력하시면 중지합니다.");
