<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    */
    ...
    if(session.getAttribute("user_id") == null) {
    	...
    	String uNick = (String) session.getAttribute("user_nick");
...
<body>
	...
	<h2><%=uNick %>(<%=uId %>)님 환영합니다!</h2>
		
	<a href="session_login.jsp">로그인 페이지로 돌아가기</a> <br>
	<a href="../JspObjrequest/req_album.jsp">⚽선수 리스트 보기⚽</a>
