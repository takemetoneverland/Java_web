...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    // 모든 페이지에 다 넣으면 부하가 커지므로 필요한 상황에서만 사용한다.
    response.setHeader("Cache-Control", "no-store"); //HTTP 1.1 방식 캐시를 사용하지 않게 함
	response.setHeader("Pragma", "no-cache"); //HTTP 1.0 방식
